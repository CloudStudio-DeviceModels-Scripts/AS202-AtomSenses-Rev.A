...
# Parsing + Configuration Script – AS202 - Atom Senses - Rev. A

This **Parsing + Configuration** script is designed for the **AS202 - Atom Senses** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – AS202 - Atom Senses Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **AS202 - Atom Senses** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
